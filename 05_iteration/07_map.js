...
const myNums = myNumbers.map((num)=>{    // we can use map to get the values from an array based on a condition with curly braces we need to return

return num * 10}).map       // returns a new array with the results of calling a provided function on every element in the calling array
((num)=>
{
    return num +1        
